...
namespace margelo::nitro::poselandmarks {
  ...
  bool JHybridPoseLandmarksSpec::initPoseLandmarker(std::optional<double> minVisibilityConfidence, std::optional<double> inferenceSampleRateHz, std::optional<double> rigidBodyWindowFrames, std::optional<double> modelSelection, std::optional<double> delegateSelection, std::optional<bool> enableVisibilityRecovery, std::optional<bool> enableRigidBodyConstraint, std::optional<bool> enableOneEuroFilter, std::optional<bool> enableMotionPrediction, std::optional<double> oneEuroMinCutoff, std::optional<double> oneEuroBeta) {
    static const auto method = _javaPart->javaClassStatic()->getMethod<jboolean(jni::alias_ref<jni::JDouble> /* minVisibilityConfidence */, jni::alias_ref<jni::JDouble> /* inferenceSampleRateHz */, jni::alias_ref<jni::JDouble> /* rigidBodyWindowFrames */, jni::alias_ref<jni::JDouble> /* modelSelection */, jni::alias_ref<jni::JDouble> /* delegateSelection */, jni::alias_ref<jni::JBoolean> /* enableVisibilityRecovery */, jni::alias_ref<jni::JBoolean> /* enableRigidBodyConstraint */, jni::alias_ref<jni::JBoolean> /* enableOneEuroFilter */, jni::alias_ref<jni::JBoolean> /* enableMotionPrediction */, jni::alias_ref<jni::JDouble> /* oneEuroMinCutoff */, jni::alias_ref<jni::JDouble> /* oneEuroBeta */)>("initPoseLandmarker");
    auto __result = method(_javaPart, minVisibilityConfidence.has_value() ? jni::JDouble::valueOf(minVisibilityConfidence.value()) : nullptr, inferenceSampleRateHz.has_value() ? jni::JDouble::valueOf(inferenceSampleRateHz.value()) : nullptr, rigidBodyWindowFrames.has_value() ? jni::JDouble::valueOf(rigidBodyWindowFrames.value()) : nullptr, modelSelection.has_value() ? jni::JDouble::valueOf(modelSelection.value()) : nullptr, delegateSelection.has_value() ? jni::JDouble::valueOf(delegateSelection.value()) : nullptr, enableVisibilityRecovery.has_value() ? jni::JBoolean::valueOf(enableVisibilityRecovery.value()) : nullptr, enableRigidBodyConstraint.has_value() ? jni::JBoolean::valueOf(enableRigidBodyConstraint.value()) : nullptr, enableOneEuroFilter.has_value() ? jni::JBoolean::valueOf(enableOneEuroFilter.value()) : nullptr, enableMotionPrediction.has_value() ? jni::JBoolean::valueOf(enableMotionPrediction.value()) : nullptr, oneEuroMinCutoff.has_value() ? jni::JDouble::valueOf(oneEuroMinCutoff.value()) : nullptr, oneEuroBeta.has_value() ? jni::JDouble::valueOf(oneEuroBeta.value()) : nullptr);
